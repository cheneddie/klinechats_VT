...
from tools.run_g2_closeout import RangeReader,compare,sha,strategy,relaxed,dump,write_gz,fsha,RUNNER_VERSION
...
def main():
 ...
 rr=RangeReader(src);cfg=ScanConfigV4Final(contract_mode='strict');done=0;viol=0;repairs=0;t0=time.time();impl=sha({'runner':RUNNER_VERSION,'reachability':REACHABILITY_VERSION,'repair':CAUSAL_REPAIR_VERSION})
 for day in work:
